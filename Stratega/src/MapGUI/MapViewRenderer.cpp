//#include <Stratega/MapGUI/MapViewRenderer.h>
...
//    }
//
//    void MapViewRenderer::init()
//    {
//        // Initialise atlas
//        std::vector<std::string> filePaths;
//        filePaths.emplace_back("../MapBuilder/Assets/lockedTile.png");
//        spritePaths.emplace(1, "../MapBuilder/Assets/lockedTile.png");
//
...
//    }
//
//    void MapViewRenderer::update(const std::vector<Vector2f>& locked)
//    {
...
////            auto rect = atlas.getSpriteRect(spritePaths.at(1));
////            auto tex = atlas.getAtlasTexture();
...
//    }
//
//    void MapViewRenderer::draw(sf::RenderTarget& target, sf::RenderStates states) const
//    {
//        // apply the transform
