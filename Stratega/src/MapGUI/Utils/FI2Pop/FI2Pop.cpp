//#include "ivypch.h"
//#include <iostream>
//#include <Stratega/MapGUI/Utils/FI2Pop/FI2Pop.h>
//
...
//			{
//				std::cout <<("FI2POP: Repopulating with random infeasible {0}", i);
...
//			if (initialisedFeasible)
//			{
//				std::cout <<("FI2POP: Computing Feasible Fitnesses");
...
//						std::cout <<("FI2POP: Top Feasible Individual. Has Diversity = {0}", diversity);
//					}
...
//						std::cout <<("FI2POP: Worst Feasible Individual. Has Diversity = {0}", diversity);
//					}
//				}
//			}
//			currGeneration += 1;
