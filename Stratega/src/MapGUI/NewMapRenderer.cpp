...
//        fowSettings.renderType = FogRenderType::Fog;
    ...
    void NewMapRenderer::init(const GameState& initialState, const GameConfig& gameConfig)
    {
        config = &gameConfig;
    ...
    void NewMapRenderer::update(const GameState& state)
    {
        this->state = state;
        updateFow();
    ...
    void NewMapRenderer::handleInput()
    {
...
//        tileMap.update(state);
    ...
    void NewMapRenderer::mouseScrolled(const sf::Event& event)
    {
    ...
    void NewMapRenderer::mouseButtonReleased(const sf::Event& event)
    {
    ...
    void NewMapRenderer::mouseButtonPressed(const sf::Event& event)
    {
    ...
    void NewMapRenderer::mouseMoved(const sf::Event& event)
    {
        if (!dragging)
            return;
    ...
    void NewMapRenderer::createWindowInfo()
    {
    ...
    void NewMapRenderer::createWindowFogOfWar()
    {
        ImGui::SetNextWindowSize(ImVec2(250, 100), ImGuiCond_FirstUseEver);
        ImGui::SetNextWindowPos(ImVec2(20, 20), ImGuiCond_FirstUseEver);
    ...
    void NewMapRenderer::createEntityInformation()
    {
    ...
    void NewMapRenderer::createActionBar()
    {
        ImGuiWindowFlags window_flags = 0;
        window_flags += ImGuiWindowFlags_NoTitleBar;
        window_flags += ImGuiWindowFlags_NoScrollbar;
    ...
    void NewMapRenderer::createWindowUnits()
    {
    ...
    void NewMapRenderer::createWindowActions()
    {
    ...
    void NewMapRenderer::createWindowPlayerParameters()
    {
    ...
    void NewMapRenderer::setPlayerPointOfView(int playerID)
    {
    ...
    ActionAssignment NewMapRenderer::getPlayerActions()
    {
    ...
    bool NewMapRenderer::isActionAvailable() const
    {
        return selectedAction.has_value();
    }

    void NewMapRenderer::updateFow()
    {
        fowState = state;
        fowState.applyFogOfWar(fowSettings.selectedPlayerID);
    }

    bool NewMapRenderer::isGameEndRequested()
    {
